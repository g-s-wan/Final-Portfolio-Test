...
export default function Redesign() {
  return (
    ...
    <Navbar />
    <div class="rr">
        <h1 class="padding">Responsive Redesign</h1>
    </div>
        <h2 class="padding">Introduction</h2>
          <div class="pink-blue fill-in-top padding"><p>Creating a responsive redesign of an existing website.</p></div>
          <div class="pink-blue fill-in-bottom">
          <p>&emsp;&emsp;&emsp;The prominence of digital communication has resulted in a myriad of electronic devices. These devices come in countless sizes, and a proper design must account for all of its users' needs. One may think of these needs as being encompassed by three metrics: usability (e.g. efficiency), learnability, and memorability. Usability concerns how easy the interface is to use, learnability how well a new user is able to learn to use the interface, and memorablility how well a user is able to use the interface after an extended period of time.<br/><br/></p>
        ...
        <div class="pink-blue fill-in-top"><p>The webpage that I chose is the homepage for <a href="https://www.thaidiner.com/">Thai Diner</a>, a restaurant in New York City that blends Thai cuisine with American diner fare. Below are several screenshots of the site:</p></div>
        <div class="pink-blue fill-in-bottom">
        ...
        <div><p>Why might this interface be concerning? Let's consider the three metrics: usability, learnability, and memorability.</p>
        <div class="lists">
        <div class="usability">
        <h4>Usability</h4>
        <ul>
        ...
        <div class="pink-blue fill-in-bottom">
          ...
          <p class="padding-top-bottom padding">In addition, I used the WAVE web accessibility evaluation tool to assess where the page could be improved in terms of accessbility.</p>
          ...
          <h4 class="padding-align">Further thoughts throughout the design process and/or invisible decisions:</h4>
          <ul class="padding-align left-align">
            <li>Each image has an alt text description.</li>
            <li>I wanted to keep some of the eccentricity of the original design, so I used the restaurant's signature dish, the Monster, as a focal image. The image quality is mediocre, but if I were redesigning this site on behalf on the restaurant, I would replace the image with a higher resolution version.</li>
        ...
        <div class="visdevs">
        <img class="visdev" src={VisGuide}/>
        <img class="visdev" src={VisGuide2}/>
        </div>
        ...
        <p class="padding">Though adding functionality to the hamburger menu was out of scope for this assignment, proof-of-concepts appear below. The left image is for a tablet display, while the right image is for a phone display. The dropdowns would encompass the whole screen.</p>
        <div class="dropdowns">
        ...
        <div class="wrapper-2">
          ...
          <a class="padding-align" href="https://softbear888.github.io/Responsive-Redesign-Final/#" id="take-me-there">Take me there!</a>
          </div>
          </div>
        <Footer />
        </div>
