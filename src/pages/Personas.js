  ...
  return (
    <div class="container">
      ...
      <div class="personas">
        ...
        <div id="intro">
          ...
          <p class="padding pink-blue" id="intro-body">&emsp;&emsp;&emsp;How can a designer understand their users? This question is an important one, as it informs countless
            design decisions for any product. Without understanding a product's users, one cannot hope to design a
            product that fits those users' needs.<br/><br/>
            &emsp;&emsp;&emsp;So how can we go about putting ourselves in the users' shoes? Techniques such as real-time observation, conducting interviews, creating empathy maps, and storyboarding all offer insight into consumers' needs. In this case, users interacted with a long-standing, but unassuming interface: a Bear Bucks kiosk. Primarily, the kiosk offers a way for Brown University students to add school currency (Bear Bucks) to their ID cards. How do they navigate this process? Keep scrolling to find out!</p>
        </div>
        <h2 class="padding">Sketch of the Interface</h2>
        <div class="sketch">
        <img src={Kiosk} class="sketch-img"/>
        <div class="list">
        <ol>
        ...
        <h2 class="padding">Observations</h2>
          <div class="pink-blue" id="observations-intro"><p class="padding-align">After watching three users add value to their ID cards with the kiosk, I noted some observations:</p></div>
        ...
        <div>
          ...
          <div class="reduced-size pink-blue">
    ...
    <div class="bottom-padding">
      ...
      <div><p class="padding-align pink-blue" id="conclusions-heading">Despite being less popular than the online portal as a method for adding Bear Bucks to one's ID, the kiosk appears to be an overall effective interface. Each user was able to successfully add money to their ID, though some adjustments might make the process more smooth:</p></div>
        <ul class="padding-align pink-blue" id="conclusions-list">
